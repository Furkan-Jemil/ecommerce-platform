            ...
            {isLoading
              ...
              : filteredOrders.map((order: Order) => (
                  <tr
                    ...
                    <td className="px-6 py-4 font-mono font-bold text-xs uppercase">
                      #{order.id.slice(-8)}
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <select
                        ...
                        className={`rounded-full px-3 py-1 text-[10px] font-bold uppercase border-0 focus:ring-2 focus:ring-primary ${
